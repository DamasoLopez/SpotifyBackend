...
public class PlayListController {
    ...
    public ResponseEntity createPlayList(@Valid @RequestBody PlayList playList) throws Exception {
		...
		@GetMapping(path = "/getAllPlaylist/{token}/{refreshToken}" )
    public Map<Integer, String> getAllPlaylist(@PathVariable String token,@PathVariable String refreshToken) throws Exception {
		
        return playListDaoImpl.getAllPlaylist(token,refreshToken);
    }
		
		@GetMapping(path = "/searchTrack/{token}/{refreshToken}/{nameSong}/{email}" )
	public Map<Integer, String> searchTrack(@PathVariable String token,@PathVariable String refreshToken,@PathVariable String nameSong,@PathVariable String email) throws Exception {
